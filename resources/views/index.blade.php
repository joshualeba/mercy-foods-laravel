...
<body>
        ...
        <section id="featured-restaurants-section" class="featured-restaurants">
             <div class="container">
                ...
                <div class="restaurant-showcase">
                    <div class="restaurant-card-new"><div class="img-container"><img src="{{ asset('multimedia/r1.png') }}" alt="Fachada de La Pizzería del Barrio"></div><div class="card-content"><h3>La Pizzería del Barrio</h3><p class="category">Pizza • Italiana</p><p class="rating">⭐ 4.8 (125 evaluaciones)</p><a href="/restaurante-detalle" class="btn-ver-mas">Ver más...</a></div></div>
            <div class="restaurant-card-new"><div class="img-container"><img src="{{ asset('multimedia/r2.png') }}" alt="Interior de Sushi Roll Express"></div><div class="card-content"><h3>Sushi Roll Express</h3><p class="category">Sushi • Japonesa</p><p class="rating">⭐ 4.9 (210 evaluaciones)</p><a href="/restaurante-detalle" class="btn-ver-mas">Ver más...</a></div></div>
            <div class="restaurant-card-new"><div class="img-container"><img src="{{ asset('multimedia/r3.png') }}" alt="Exterior de Tacos El Campeón"></div><div class="card-content"><h3>Tacos "El Campeón"</h3><p class="category">Tacos • Mexicana</p><p class="rating">⭐ 4.7 (98 evaluaciones)</p><a href="/restaurante-detalle" class="btn-ver-mas">Ver más...</a></div></div>
                </div>
            </div>
        </section>
    ...
    <footer class="site-footer">
        <div class="container"><div class="row"><div class="col-lg-4 col-md-6"><div class="footer-about"><a href="#" class="footer-logo"><img src="{{ asset('multimedia/logo.png') }}" alt="Mercy Food Logo"><span>Mercy Food</span></a><p>Conectando los sabores de tu localidad con la puerta de tu casa. Apoya el comercio local con cada pedido.</p></div></div><div class="col-lg-2 col-md-6"><div class="footer-links"><h4>Navegación</h4><ul><li><a href="#">Inicio</a></li><li><a href="#featured-restaurants-section">Restaurantes</a></li><li><a href="#partners-section">Únete</a></li><li><a href="/registro">Registrarse</a></li></ul></div></div><div class="col-lg-3 col-md-6"><div class="footer-links"><h4>Legal</h4><ul><li><a href="#" id="open-terms-link">Términos y condiciones</a></li><li><a href="#" id="open-modal-link">Política de privacidad</a></li><li><a href="#" id="open-faq-link">Preguntas frecuentes</a></li></ul></div></div><div class="col-lg-3 col-md-6"><div class="footer-social"><h4>Síguenos</h4><div class="social-icons"><a href="#" aria-label="Facebook"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg></a><a href="#" aria-label="Instagram"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg></a><a href="#" aria-label="Twitter"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg></a></div></div></div></div><div class="footer-bottom"><p>&copy; 2025 Mercy Food. Todos los derechos reservados.</p></div></div>
    </footer>
